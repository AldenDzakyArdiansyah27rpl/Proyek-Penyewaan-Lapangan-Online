                        ...
                        {this.state.users.map((item) => {
                            return (
                                <tr key={item._id}>
                                    ...
                                    <td>{item.description ? <span>{item.description}</span> : <span>Belum Diatur</span>}</td>
                                    <td>{item.email}</td>
                                    <td>{item.age ? <span>{item.age}</span> : <span>Belum Diatur</span>}</td>
                                    <td>{item.address ? <span>{item.address}</span> : <span>Belum Diatur</span>}</td>
                                    <td>{item.country ? <span>{item.country}</span> : <span>Belum Diatur</span>}</td>
                                    <td>{item.phoneNumber ? <span>{item.phoneNumber}</span> : <span>Belum Diatur</span>}</td>
                                    <td>{item.role}</td>
