...
export default class SelectedLot extends Component {
    ...
    handleSelectedLot() {
        ...
        if (selected) {
            this.setState({ selectedLot: JSON.parse(selected), userId: JSON.parse(_id), status: "Dipakai" })
        } else {
            alert('Silahkan Pilih Lapangan Sebelum Melanjutkan')
            window.location.assign('/')
        }
    }
    ...
    handleFormSubmit(e) {
        ...
        alert('Silahkan Hubungi ' + this.state.selectedLot.contact + ' Untuk Mengurus Penyewaan')
            ...
            <Fragment>
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <br />
                        <div className="row">
                            <div className="col-md-4">Lokasi:</div>
                        ...
                        <div className="row">
                            <div className="col-md-4">Harga:</div>
                            <div className="col-md-4">{this.state.selectedLot.price}</div>
                        </div>
                        <div className="row">
                            <div className="col-md-4">Status:</div>
                            <div className="col-md-4">{this.state.selectedLot.status === "Tersedia" ? <span className="text-success">{this.state.selectedLot.status}</span> : <span className="text-danger">{this.state.selectedLot.status}</span>}</div>
                        </div>
                        <div className="row">
                            <div className="col-md-4">Durasi:</div>
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                Penyewaan akan selesai pada
                            </div>
                            <div className="col-md-12">
                                {this.state.endedTime}
                                <form onSubmit={this.handleFormSubmit} className="form-block">
                                    <button className=" btn btn-sm btn-outline-primary btn-block col-md-8" disabled={this.state.selectedLot.status === "Not Available"} >Sewa sekarang</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row d-flex justify-content-center" style={{ marginTop: "250px" }}>
                    <div className="col-md-2" >
                        <button onClick={this.handleChangeSelectedLot} className="btn btn-outline-primary btn-block">
                            <MdModeEdit /> Ubah Lapangan yang dipilih
                        </button>
                    </div>
                </div>
